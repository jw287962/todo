...
function repopulateAllProjectArray(){
      ...
      (0,_addHtml_js__WEBPACK_IMPORTED_MODULE_2__.repopulateHTMLFromArray)(allProjects);
...
function checkProjectView(boolean){
    ...
    if(boolean){
       ...
       return boolean;
        ...
        (0,_addHtml_js__WEBPACK_IMPORTED_MODULE_2__.repopulateHTMLFromArray)(allProjects[projectNum]);
...
function doTodoFormSubmission(event){
  ...
  console.log("submit form submission");
     ...
     const todoItems = (0,_todo_js__WEBPACK_IMPORTED_MODULE_0__.todoProject)(allProjects[projectNum].getProjectName());
  // Here
    if(todoData.titleText.length!=0){   

        console.log(allProjects[projectNum]);
    todoItems.addProjectItem((0,_logic_js__WEBPACK_IMPORTED_MODULE_3__.updateArrayTodoList)(todoData.titleText,todoData.descriptionText,todoData.dateText,todoData.priorityText));
...
// Here
        ...
        const holderTodo = (0,_logic_js__WEBPACK_IMPORTED_MODULE_3__.updateArrayTodoList)(todoData.titleText,todoData.descriptionText,todoData.dateText,todoData.priorityText);
