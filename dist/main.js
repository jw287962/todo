...
const todoNewItem = (0,_todo_js__WEBPACK_IMPORTED_MODULE_0__.todoItem)();
    ...
    todoDiv.appendChild((0,_addHtml_js__WEBPACK_IMPORTED_MODULE_2__.addNewTodo)(todoNewItem.getTitle(),
...
dateInputData.value = (0,_addHtml_js__WEBPACK_IMPORTED_MODULE_2__.getCurrentDate)();
...
function removeTodoHTML(element){
 ...
 console.clear();
  return function(){
    (0,_addHtml_js__WEBPACK_IMPORTED_MODULE_2__.deleteTodo)(toRemoveDiv);
